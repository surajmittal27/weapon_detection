...
#to access the homepage we need to be logged in
#if we go to the main page it displays the home page even without being logged in so, we tell the system that to access the main page the system needs to be logged in
...
#primary key is the way we get the images and it is also the primary key
